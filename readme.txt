...
AdPush plugin is a superb solution to earn money by placing ads to WordPress website pages, posts, custom posts, search results, categories, tags, and widgets.
...
If you have a feature suggestion or idea you'd like to see in the plugin, we'd love to hear about it! [Suggest a Feature](<support@gasplugin.com>)
...
3. The plugin settings are located in "AdPush".

== Frequently Asked Questions ==

= AdPush plugin installed, but it does not appear in the list of plugins in the Wordpress admin dashboard. Why? =

It is possible that you have AdBlock browser extension (or similar software) installed in your browser and it blocks ads. Disable AdBlock extension to see the AdPush plugin and make necessary changes.

= AdPush plugin doesn't work (ads not displaying). What should I do? =
...
2. Make sure that AdPush plugin is installed and activated.
3. Navigate to the Appearance > Widgets section and add the AdPush widget to the available sidebar.
...
4. Ads Settings page (Authorized in Google AdSense and vi stories ).
5. Ads page (Authorized in Google AdSense).
6. vi stories Player customization form.
7. Google AdSense Ads and vi stories Ads in the front-end (Before the content).

== Changelog ==

= V1.50 - 09.04.2020 =
* Update : Plugin was renamed.
* Update : The plugin settings page was updated.
